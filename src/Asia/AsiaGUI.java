...
public class AsiaGUI implements GUI
{
	...
	{
		frame = new JFrame("Asia Map");
		frame.setSize(960, 770);
	...
	public void createQuiz()
	{
		...
		jd.setTitle("Asia Quiz");
		jd.setLocation(1193, 220);
		jd.setVisible(true);
