...
public class Asia extends Continent
{
	public Asia()
	{
		countries = new Country[] {new Country("Afghanistan", "Kabul"), new Country("Armenia", "Yerevan"), 
								   ...
								   new Country("Philippines", "Manila"), new Country("Qatar", "Doha"),
								   new Country("Russia", "Moscow"), new Country("Saudi Arabia", "Riyadh"),
								   new Country("Singapore", "Singapore"), new Country("South Korea", "Seoul"),
								   new Country("Sri Lanka", "Sri Jayawardenepura Kotte"), 
